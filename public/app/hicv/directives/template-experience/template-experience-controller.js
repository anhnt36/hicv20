...
angular
    .module('hicv.design')
    .controller('TemplateExperienceController', TemplateExperienceController);

/* @ngInject */
function TemplateExperienceController($scope, $rootScope, DesignService) {
    var $ctrl = this;
    $ctrl.fieldCheck = ['company', 'location', 'shortSummary'];
    $ctrl.displayPopover = [];
    $ctrl.visit = '';
    $ctrl.focus = false;
